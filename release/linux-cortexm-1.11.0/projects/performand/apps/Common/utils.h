...
extern int lock_file(struct flock *fl, char *file_name, int *fd, ssize_t o_flags);
extern void unlock_file(struct flock *fl, int *fd);
...
extern int format_timespec(char* str, struct timespec *ts);
